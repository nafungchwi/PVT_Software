...
def blackPlots(dTab,eTab,fOil,fGas,clsBLK,clsUNI) :
...
#-- Create the GOR/CGR Plot -----------------------------------------
        ...
        figN = graphOut + "/" + simT + "_GOR_CGR.png"    
...
#-- Create the Oil FVF/Viscosity Plot -------------------------------
        ...
        figN = graphOut + "/" + simT + "_Oil_FVF_VIsc.png"    
...
#-- Create the Gas FVF/Viscosity Plot -------------------------------
        ...
        figN = graphOut + "/" + simT + "_Gas_FVF_Visc.png"    
...
#----------------------------------------------------------------------
    ...
    if iOil == 0 : underSatOilPlot(simT,fOil,clsBLK,clsUNI)

    if iGas == 0 : underSatGasPlot(simT,fGas,clsBLK,clsUNI)
...
def underSatOilPlot(simT,fOil,clsBLK,clsUNI) :
...
def underSatGasPlot(simT,fGas,clsBLK,clsUNI) :
